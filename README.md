...
| [webui/advanced.html](webui/advanced.html) | **进阶篇（第 13 章配套）**：应用——5 张领域 agent 配方卡 + 五种多 agent 编排模式（含消息流向动画与真代码骨架）；构架——7 层 + 4 横切最佳实践蓝图 + 三项目覆盖矩阵 + M0→M11 施工路线 + 十条贴墙清单 |
...
生成于 2026-07-11，基于 pi v0.80.6 (`4c18610`) 与 tau v0.1.5；2026-07-16 复核至 pi v0.80.7 / tau v0.1.6（仓库现挂 `huggingface/tau`）/ rust-ai-agent ep05。
